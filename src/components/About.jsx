        ...
        >
            <div className="bg-white dark:bg-black rounded-2xl shadow-lg p-4 sm:p-6 md:p-8 border-l-4 border-red-500 dark:border-red-700 flex flex-col md:flex-row items-center gap-4 md:gap-6">
                ...
                <motion.div
                    ...
                    className="w-24 h-24 sm:w-32 sm:h-32 md:w-35 md:h-35 rounded-full bg-gradient-to-tr from-red-600 to-red-800 flex items-center justify-center shadow-lg"
                >
                    <motion.img
                        src={avatar}
                        alt="Avatar"
                        className="w-20 h-20 sm:w-28 sm:h-28 md:w-30 md:h-30 rounded-full object-cover shadow-xl border-4 border-red-500"
